...
// @ts-ignore
const ConferenceTable = ({tableData}) => {
        ...
        columnHelper.accessor(row => null, {
            ...
            cell: info => (
                <Typography
                    ...
                    className="text-truncate text-truncate__1"
                >
                    {info?.row?.original?.time + " | " + info?.row?.original?.date}
                </Typography>
            ),
            width: 150,
        }),
                ...
                <>
                    ...
                    <Tooltip title="مشاهده">
                        <IconButton
                            color="secondary"
                            LinkComponent={Link}
                            href={process.env.NEXT_PUBLIC_DOMAIN + "/conference/" + info?.row?.original?.type + "/" + info?.row?.original?.slug}
                            style={{marginLeft: 8}}
                        >
                            <FiEye size={16}/>
                        </IconButton>
